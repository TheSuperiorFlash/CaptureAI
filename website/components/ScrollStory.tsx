                    ...
                    >
                        ...
                        <div className="flex w-full items-center justify-between border-b border-white/5 bg-white/[0.02] px-4 py-3 relative overflow-hidden">
                            <div className="flex items-center gap-4">
                                ...
                                {/* Cluttered Tabs */}
                                <motion.div style={{ opacity: clutterOpacity }} className="absolute left-[100px] md:left-24 flex gap-1.5 md:gap-2 pointer-events-none">
                                ...
                                {/* Clean Tab */}
                                <motion.div style={{ opacity: cleanOpacity }} className="absolute left-[100px] md:left-24 flex gap-1.5 md:gap-2 pointer-events-none">
                                    <div className="inline-flex h-4 w-16 md:h-6 md:w-24 rounded bg-white/10" />
                                </motion.div>
                            </div>
                        ...
                        <div className="relative flex h-full w-full flex-col p-6 overflow-hidden">
                            ...
                            <motion.div style={{ opacity: cleanOpacity }} className="absolute inset-0 pointer-events-none">
                                {/* Top-Left Quiz Area */}
                                <div className="absolute top-10 left-8 right-8 md:right-auto md:top-14 md:left-14 md:w-full md:max-w-[400px] flex flex-col gap-6 md:gap-8 origin-top scale-[0.85] md:scale-100">
                                    ...
                                    <div className="relative">
                                        ...
                                        <motion.div
                                            className="absolute -inset-1 md:-inset-5 overflow-hidden rounded-xl border-2 border-dashed border-cyan-400/50 bg-cyan-400/5 mix-blend-screen"
                                            style={{
