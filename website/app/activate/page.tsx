                                    ...
                                    <div className="mb-7 flex items-end gap-3">
                                        ...
                                        {!isTrial && (
                                            <button
                                                ...
                                                className="mb-0 flex-shrink-0 inline-flex items-center rounded-full border border-cyan-400/30 bg-cyan-400/[0.06] px-4 py-1.5 text-sm font-semibold text-cyan-400 transition-all hover:bg-cyan-400/10 hover:border-cyan-400/50 whitespace-nowrap"
                                            >
                                                Try $0.99 for 7 days
                                            </button>
                                        )}
