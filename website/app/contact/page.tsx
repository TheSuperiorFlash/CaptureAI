            ...
            <div className="relative z-10 mx-auto max-w-3xl px-6">
                ...
                <div className="mb-8 grid gap-6 sm:grid-cols-2">
                    ...
                    <div className="glass-card rounded-2xl p-7">
                        ...
                        <h2 className="mb-4 text-lg font-semibold text-[--color-text]">Support</h2>
                    ...
                    <div className="glass-card rounded-2xl p-7">
                        ...
                        <h2 className="mb-4 text-lg font-semibold text-[--color-text]">Feedback</h2>
                        <p className="mb-6 text-sm text-[--color-text-tertiary]">
                ...
                <div className="gradient-border rounded-2xl">
                    <div className="rounded-2xl bg-gradient-to-b from-blue-500/[0.06] to-cyan-500/[0.02] p-8 text-center">
                        ...
                        <h3 className="mb-4 text-[--color-text]">Looking for answers first?</h3>
                        <p className="mb-6 text-sm text-[--color-text-tertiary]">
