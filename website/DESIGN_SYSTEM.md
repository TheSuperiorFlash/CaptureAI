...
| `components/Features.tsx` | 8-feature grid with 3D tilt cards + dynamic glass glare, infinite mobile swipe carousel. Supports optional `mobileDescription` for responsive text. |
