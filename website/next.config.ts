        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              `script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://analytics.tiktok.com https://business-api.tiktok.com${process.env.NODE_ENV === 'development' ? " 'unsafe-eval'" : ''}`,
