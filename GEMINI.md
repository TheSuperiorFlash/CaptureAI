...
|------------------|--------------------|
| API routes, auth, rate limits, AI models, webhooks | [api/ARCHITECTURE.md](api/ARCHITECTURE.md) + [CLAUDE.md](CLAUDE.md) + This file |
| Extension modules, storage keys, message actions, Privacy Guard | [extension/ARCHITECTURE.md](extension/ARCHITECTURE.md) + [CLAUDE.md](CLAUDE.md) + This file |
