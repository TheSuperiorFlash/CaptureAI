...
| `ocr-service.js` | Tesseract.js v7.0.0 OCR with 60% confidence threshold, 3x upscale preprocessing, site-specific cleanup |
...
3. If OCR enabled: Tesseract.js v7.0.0 processes with 3x upscale + grayscale + box blur
