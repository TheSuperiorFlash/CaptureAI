...
[![Version](https://img.shields.io/badge/version-2.0.1-orange.svg)](extension/manifest.json)
...
- **OCR Text Extraction** — Tesseract.js v7 extracts text for 90% token cost reduction
...
**Stack:** Manifest V3 + ES6 Modules + Tesseract.js v7 + Cloudflare Workers (D1) + AI Gateway + Stripe
